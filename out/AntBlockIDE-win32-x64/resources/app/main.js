...
var fs = require('fs');
fs.writeFile(path.join(__dirname, '\\arduino-manager\\arduinoSettings.json'), json, 'utf8', function (err) {	//fs.writeFile(pathToApp + '\\arduino-manager\\arduinoSettings.json', json, 'utf8', function (err) {
    if (err) {
